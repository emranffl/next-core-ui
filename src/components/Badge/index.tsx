...
const Badge = ({
  ...
  const ConditionalIcon = ({ iconPosition }: { iconPosition: keyof typeof BADGE_ICON_POSITIONS }) => {
                ...
                : variant == "info"
                  ...
                  : variant == "neutral"
                    ...
                    : variant == "warning"
                      ...
                      : null,
        "inline-flex place-content-center place-items-center py-2 text-sm font-medium",
        className
      )}
      id={id}
      ref={internalRef}
...
export default memo(
  forwardRef((props: BadgeProps, ref: LegacyRef<HTMLSpanElement>) => <Badge {...props} internalRef={ref} />)
)
