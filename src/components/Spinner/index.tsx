...
export enum SPINNER_TRACK_COLORS {
  white = "white",
  light = "light",
  dark = "dark",
}

export enum SPINNER_TEXT_POSITIONS {
  top = "top",
  bottom = "bottom",
}
...
export interface SpinnerProps {
  ...
  text?: {
    ...
    value: string
    /**
     * The position of the text, @see `SPINNER_TEXT_POSITIONS` enum
     */
    position?: keyof typeof SPINNER_TEXT_POSITIONS
  }
  /**
