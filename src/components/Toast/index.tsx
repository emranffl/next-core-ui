	...
	return (
		<>
			{visibilityState ? (
				...
				>
					<div
						className={classManipulator(`m-8 flex w-full max-w-md items-center space-x-4 p-12 rounded-lg border shadow-md dark:bg-slate-800 dark:text-slate-400 z-10
        ${
					variant === "primary" &&
					...
					>
						<div className="flex space-x-8 w-full">
							<>
								...
								{/* // + Close Button */}
								{(closeButtonVisibility == true || autoClose == false) &&
									!closeOnClick && (
